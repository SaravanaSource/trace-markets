...
class BronzeStorage:
    """
    Responsible for determining where Bronze data is stored
    and maintaining Bronze metadata.

    Serialization is delegated to the configured storage engine.
    """
    ...
    def save(
        ...
        logger.success(
            f"Bronze file written -> {file_path}"
        )
